...
# Warming function that runs every 5 minutes
@app.function(
    schedule=modal.Cron("*/5 * * * *"),
    secrets=[modal.Secret.from_name("API_KEY")]
)
def keep_warm():
    health_url = "https://jaydenalejandro12--sd-model-health.modal.run"
    generate_url = "https://jaydenalejandro12--sd-model-generate.modal.run"
